    ...
    return (
        <div className="px-3 py-10 mx-auto w-full md:w-[90%] xl:w-[70%] space-y-10">
            ...
            <form
                ...
                {/*        {(provided) => (*/}
                {/*            <div ref={provided.innerRef} {...provided.droppableProps} className="bg-amber-400 p-1">*/}
                {/*                {parsedLyrics.map((data, fakeDataIndex) => {*/}
                {/*                    console.log("parsedLyrics:", parsedLyrics)*/}
                {/*                    return (*/}
                {/*                        <Draggable*/}
                {/*                            key={fakeDataIndex}*/}
                {/*                            draggableId={String(fakeDataIndex)}*/}
                {/*                            index={fakeDataIndex}*/}
                {/*                        >*/}
                {/*                            {(provided) => (*/}
                {/*                                <div*/}
                ...
                {/*                                >*/}
                {/*                                    <div>*/}
                {/*                                        {data.lineData.map((d, index) => {*/}
                {/*                                            return (*/}
                {/*                                                <div key={index}>{d.text}</div>*/}
                {/*                                            )*/}
                {/*                                        })}*/}
                {/*                                    </div>*/}
                {/*                                </div>*/}
