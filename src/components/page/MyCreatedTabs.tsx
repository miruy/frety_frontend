...
const MyCreatedTabs = ({myCreatedTabData, userName}: {
    myCreatedTabData: PageRsSearchTabsResponse,
    userName: string
}) => {
    ...
    const {
        ...
        queryKey: ['MyCreatedTabs', currentPage], // 쿼리 키
        queryFn: () => searchTabs({sort: 'RECENT', page: currentPage, pageSize: 10}),
        initialData: currentPage === 0 ? myCreatedTabData : undefined,
    });
