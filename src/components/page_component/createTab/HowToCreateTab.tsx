    ...
    return (
        <div className="py-10 space-y-2">
            ...
            <div className="text-sm ml-1.5 space-y-1">
                ...
                <div className="text-muted-foreground ml-8"><span className="font-bold">- Enter : </span>가사 업로드</div>

                <div className="text-muted-foreground ml-8"><span className="font-bold">- ESC : </span>코드 선택기 닫기</div>
